...
openapi-generator generate -i resources.yaml -g rust -o ../../client/rust-esc    --import-mappings=chrono::DateTime=chrono::DateTime  '--type-mappings=DateTime=chrono::DateTime<chrono::Utc>' -t templates/rust-esc
